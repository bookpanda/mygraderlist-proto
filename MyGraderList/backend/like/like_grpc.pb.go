...
const (
	LikeService_FindByUserId_FullMethodName = "/like.LikeService/FindByUserId"
	LikeService_Create_FullMethodName       = "/like.LikeService/Create"
...
type LikeServiceClient interface {
	FindByUserId(ctx context.Context, in *FindByUserIdLikeRequest, opts ...grpc.CallOption) (*FindByUserIdLikeResponse, error)
...
func (c *likeServiceClient) FindByUserId(ctx context.Context, in *FindByUserIdLikeRequest, opts ...grpc.CallOption) (*FindByUserIdLikeResponse, error) {
	out := new(FindByUserIdLikeResponse)
...
func (UnimplementedLikeServiceServer) FindByUserId(context.Context, *FindByUserIdLikeRequest) (*FindByUserIdLikeResponse, error) {
...
func _LikeService_FindByUserId_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(FindByUserIdLikeRequest)
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LikeServiceServer).FindByUserId(ctx, req.(*FindByUserIdLikeRequest))
	}
